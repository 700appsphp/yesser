Yesser::Application.configure do
  ...
  config.action_mailer.default_url_options = {:host => "yesser.herokuapp.com"}
  ...
  Yesser::Application.config.middleware.use ExceptionNotification::Rack,
  :email => {
    :email_prefix => "[yesser][errors] ",
    :sender_address => %{"yesser" <yesser.be0@gmail.com>},
    :exception_recipients => %w{moemen@cubeegypt.com k.sonbol@cubeegypt.com}
  }
